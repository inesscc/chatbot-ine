#!/usr/bin/env python3
"""
Update tools-export.json with the current postgres_llm_tool.py content
"""
...
with open('/home/jeconchao/repos/oui/tools-export.json', 'r') as f:
...
with open('/home/jeconchao/repos/oui/tools-export.json', 'w') as f:
